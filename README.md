...
> **Couche 2 — Execution Kernel** | [oo-system architecture](https://github.com/Djiby-diop/oo-system)
...
Rust agent runtime and execution kernel for the [Operating Organism](https://github.com/Djiby-diop/oo-system).
